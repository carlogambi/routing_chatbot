...
import 'package:routing_app/InputMessage/components/Navigattion/NavigationPopup.dart';
...
class _HomePageDialogflow extends State<HomePageDialogflow> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: this._navigationPopupOpen
          ? NavigationPopup(data: this.collectedData)
          : Stack(
              children: <Widget>[
